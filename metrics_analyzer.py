...
def calculate_maintainer_responsiveness(
    issues,
    comments
):
...
def calculate_activity_recency(
    comments
):
...
def calculate_overall_health_score(
    ...
    closing_score = max(
        0,
        100 - issue_closing_time
    )

    stale_score = max(
        0,
        100 - stale_percentage
    )
...
def generate_metrics_summary(
    ...
    (
        ...
        calculate_maintainer_responsiveness(
            open_issues,
            comments
        )
    )
